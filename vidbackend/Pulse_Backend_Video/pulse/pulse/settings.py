...
SECRET_KEY = 'django-insecure-+g0yj8591_i2=1w98+28doknsgzpd^ungitcxzv0*vfkedl#sm'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'videos'),
        'USER': os.environ.get('DB_USER', 'admin'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'testadmin'),
